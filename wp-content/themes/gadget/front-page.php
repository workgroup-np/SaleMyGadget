...
if ( get_option( 'show_on_front' ) == 'page' ) { // Display static front page if is set.
							...
							<div class="flex-img">                    	           
								...
								<div class="top-carousel-img">  
									...
									if ( has_post_thumbnail( $loop->post->ID ) ) {
										echo get_the_post_thumbnail( $loop->post->ID, 'sale-my-gadget-carousel' );
									} else {
	...
	<?php } ?>	
		<div class="row rsrc-content"> 	
			<?php if ( ! is_active_sidebar( 'sale-my-gadget-home-sidebar' ) ) : ?>
			...
			<?php else : ?>
				<aside id="sidebar-secondary" class="col-md-3 rsrc-left" role="complementary" itemscope itemtype="http://schema.org/WPSideBar">
					<?php dynamic_sidebar( 'sale-my-gadget-home-sidebar' ); ?>
				</aside>
			<?php endif; ?>
				...
				<div <?php post_class( 'rsrc-post-content' ); ?>>                                                      
					<div class="entry-content">
						...
						if ( $loop->have_posts() ) :
							...
							<p class="text-center">	
								<?php esc_html_e( 'No products found', 'sale-my-gadget' ); ?>
							</p>
						<?php endif; ?>
					</div>                                                       
				</div>        
