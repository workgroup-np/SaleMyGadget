...
<div class="row rsrc-content">    
	...
	<article class="col-md-<?php sale_my_gadget_main_content_width(); ?> rsrc-main" itemscope itemtype="http://schema.org/BlogPosting">
		<link itemprop="mainEntityOfPage" href="<?php the_permalink(); ?>" />
		<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>         
				<?php sale_my_gadget_breadcrumb(); ?>         
				...
				<div <?php post_class( 'rsrc-post-content' ); ?>>                            
					...
					<div class="post-navigation row">
						<div class="post-previous col-md-6"><?php previous_post_link( '%link', '<span class="meta-nav">' . __( 'Previous:', 'sale-my-gadget' ) . '</span> %title' ); ?></div>
						<div class="post-next col-md-6"><?php next_post_link( '%link', '<span class="meta-nav">' . __( 'Next:', 'sale-my-gadget' ) . '</span> %title' ); ?></div>
					</div> 
