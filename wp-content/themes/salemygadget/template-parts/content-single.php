...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		...
		<div class="entry-meta">
			...
			<?php if (get_theme_mod('gadget_sharelink' ) !='1' ){ gadget_close_summary_div(); }?>
		</div><!-- .entry-meta -->
	</header><!-- .entry-header -->
...
<div class="author-title"> <?php _e('Article By :', 'gadget'); ?> <?php the_author_posts_link(); ?></div>
	...
	<?php if ( get_theme_mod('gadget_randompost' ) !='1') { get_template_part('/template-parts/random-posts');} ?>
